...
tiff(filename = "figures/p5/artifact-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
tiff(filename = "figures/p5/complete_flakes-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
tiff(filename = "figures/p5/broken_flakes-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
tiff(filename = "figures/p5/cores-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
tiff(filename = "figures/p5/tools-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
plot4 = levelplot(nw.hs.rast, col.regions = colpal, main = paste0("recycled artifact hotspots overlap with ", percentage, "% of unweathered artifact hotspots"))
plot(plot4)

allperc = rbind(perc.sw, perc.mw, perc.ww, perc.nw) %>% filter(value == 1)

tiff(filename = "figures/p5/strongly-weathered-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
tiff(filename = "figures/p5/mildly-weathered-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
tiff(filename = "figures/p5/weakly-weathered-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
...
tiff(filename = "figures/p5/unweathered-recycling-overlap.tiff", 
     units="in", 
     width=5*2, 
     height=4*2, 
     pointsize=12, 
